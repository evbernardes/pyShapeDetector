    ...
    def _get_sliceplane(self, axis, value, direction):
        ...
        for t in self.triangles:
            ...
            if bool_sum == 0: # triangle completely inside --> add and continue
                ...
                continue
            elif bool_sum == 2: # two vertices outside, add triangle using both intersections
                ...
                # add new triangle 
                new_triangles.append([vertex_in_index, _compute_intersection(vertex_in_index, vertex_out_1_index), 
                ...
                new_triangles.append([vertex_in_1_index, _compute_intersection(vertex_in_1_index, vertex_out_index), vertex_in_2_index])
                new_triangles.append([_compute_intersection(vertex_in_1_index, vertex_out_index), 
                    _compute_intersection(vertex_in_2_index, vertex_out_index), vertex_in_2_index])
